...
var StoreJobOfferComponent = (function () {
    function StoreJobOfferComponent(restangular) {
        this.restangular = restangular;
    }
    StoreJobOfferComponent.prototype.ngOnInit = function () {
        var _this = this;
        // GET http://localhost:8000/api/
        this.restangular.one('joboffer', id).one("workers").get().subscribe(function (response) {
            _this.jobOffer = response.data;
        });
    };
...
StoreJobOfferComponent = __decorate([
    core_1.Component({
        selector: 'store-job-offer',
        templateUrl: './store.job-offer.component.html',
    }),
